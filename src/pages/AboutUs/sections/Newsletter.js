        ...
        <Grid container alignItems="center">
          ...
          <Grid item md={6} sx={{ ml: { xs: 0, lg: 3 }, mb: { xs: 12, md: 0 } }}>
            ...
            <MKTypography variant="body2" color="text" mb={3}>
              Would you like to keep up with us and learn more about records in Nigeria? Subscribe
              here
            </MKTypography>
          ...
          <Grid item xs={12} md={5} sx={{ ml: "auto" }}>
            <MKBox position="relative">
              <MKBox component="img" src={newsletter} alt="verifypronewsletter" width="100%" />
            </MKBox>
          </Grid>
        </Grid>
      </Container>
